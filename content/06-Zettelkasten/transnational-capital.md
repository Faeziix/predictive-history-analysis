---
type: concept
title: Transnational Capital
category: actor
source_episodes: ["Game Theory #7", "Game Theory #13", "Game Theory #17"]
---
...
3. **Host-parasite dynamics.** Capital attaches to the dominant empire (currently the US). It extracts wealth until the host weakens, then jumps to the next host. The predicted next host: [[israel-actor|Israel]].

4. **[[intelligence-networks]]** - Use agencies like Mossad and CIA as enforcement arms. The [[CLAIM-013-epstein-intel-networks|Epstein network]] is an example: compromise and control elites through blackmail.
...
- Relocating trillions to Israel to fund the Greater Israel Project and [[pax-judaica-concept|Pax Judaica]]
